...
if __name__ == '__main__':
    ...
    for idx_max in arr_idx_max:
        ...
        print(N,X,Y)
        img[max(Y-1,0):min(Y+1,1280), max(X-1,0):min(X+1,720), 0] = 0
        img[max(Y-1,0):min(Y+1,1280), max(X-1,0):min(X+1,720), 1] = 0
        img[max(Y-1,0):min(Y+1,1280), max(X-1,0):min(X+1,720), 2] = 255
